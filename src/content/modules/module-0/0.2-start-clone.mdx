...
## Step 3: Clone MarketFlow

MarketFlow is the sample marketing project we'll use throughout this course. Ask Claude to clone it:

```
Clone the MarketFlow starter project from cc4-marketing/marketflow-starter
```
...
- ✅ MarketFlow project cloned
- ✅ Project structure ready

In **Module 1**, you'll learn the core concepts of Claude Code with real marketing examples. We'll start with an introduction to your MarketFlow project and how to work with marketing files.
