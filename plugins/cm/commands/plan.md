...
- `--audience <personas>`: Target audience (comma-separated)
  - Example: `--audience "Startup Sam, Manager Maria"`
...
🎭 Analyzing target audience...
   Primary: Startup Sam (40% budget recommended)
   Secondary: Manager Maria (40% budget recommended)
   Tertiary: Solo Steve (20% budget recommended)
...
### Primary: Startup Sam (40% of budget - $20K)
...
### Secondary: Manager Maria (40% of budget - $20K)
...
### Tertiary: Solo Steve (20% of budget - $10K)
...
- ✅ Startup Sam converts 2x better than initially expected
